...
const Home = () => {
  return (
      <div
        className="relative min-h-dvh w-full overflow-hidden bg-red-200 bg-cover bg-bottom bg-no-repeat flex flex-col justify-between"
        style={{
          backgroundImage:
      ...
      >
        ...
        />
        <div className="relative z-10 w-full border-t-4 border-[#f3a45d] bg-white/95 px-5 py-5 pb-7 backdrop-blur-sm sm:px-8 sm:py-7 md:mx-auto md:mb-8 md:max-w-xl md:rounded-xl md:border-t-0 md:shadow-lg">
          <p className="mb-2 text-xs font-bold uppercase tracking-[0.2em] text-[#c7662f]">Move freely</p>
